...
function Navbar() {
  ...
  // console.log(user.user.email) stroke Linecap class  Lux Nova
  const logout = () => {
    ...
    <div className='bg-white sticky top-0 z-50'>
      ...
      <header className="relative bg-white">
        ...
        style={{ backgroundColor: mode === 'dark' ? 'rgb(62 64 66)' : '', color: mode === 'dark' ? 'white' : '', }}>
          Get free delivery on orders over ₹900 
        </p> */}
        <p className="flex h-10 items-center justify-center px-4 text-sm font-medium" 
    style={{ 
        backgroundColor: mode === 'dark' ? 'rgb(62 64 66)' : ' rgb(112 111 111)', 
        ...
        <nav aria-label="Top" className="bg-gray-100 px-4 sm:px-6 lg:px-8 shadow-xl " style={{ backgroundColor: mode === 'dark' ? '#282c34' : '', color: mode === 'dark' ? 'white' : '', }}>
          <div className="">
            <div className="flex h-16 items-center">
              ...
              >
                <span className="sr-only">Open metnu</span>
